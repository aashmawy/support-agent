...
def _init_db(db_path: str):
    ...
    conn.execute("INSERT OR REPLACE INTO accounts (id, name, tier, is_enterprise) VALUES (?,?,?,?)", ("ACME-001", "Acme Corp", "professional", 0))
    conn.execute("INSERT OR REPLACE INTO accounts (id, name, tier, is_enterprise) VALUES (?,?,?,?)", ("ACME-ENT-09", "Acme Enterprise", "enterprise", 1))
